        ...
        <div>
            {
                user ? <></> : <Container>
                    <div className='d-flex flex-column gap-1 mt-2'>
                        <Button onClick={handleGithubSignIn} className='border border-dark-50' variant="light"> <FaGithub></FaGithub> Sign In with Github</Button>{' '}
            ...
            <h4 className='mt-4 text-center'>Courses</h4>
            <div className='mt-3'>
                {
